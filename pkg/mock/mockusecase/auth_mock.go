...
func (m *MockAuthUseCase) AdminLogin(ctx context.Context, loginDetails request.Login) (domain.Admin, error) {
	m.ctrl.T.Helper()
...
// AdminSignUpOtpSend mocks base method.
func (m *MockAuthUseCase) AdminSignUpOtpSend(ctx context.Context, phone string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AdminSignUpOtpSend", ctx, phone)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AdminSignUpOtpSend indicates an expected call of AdminSignUpOtpSend.
func (mr *MockAuthUseCaseMockRecorder) AdminSignUpOtpSend(ctx, phone interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AdminSignUpOtpSend", reflect.TypeOf((*MockAuthUseCase)(nil).AdminSignUpOtpSend), ctx, phone)
}
...
// AdminSignUpOtpVerify indicates an expected call of AdminSignUpOtpVerify.
func (mr *MockAuthUseCaseMockRecorder) AdminSignUpOtpVerify(ctx, otpVerifyDetails interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AdminSignUpOtpVerify", reflect.TypeOf((*MockAuthUseCase)(nil).AdminSignUpOtpVerify), ctx, otpVerifyDetails)
}
