...
type ProductRepository interface {
	...
	// GetCategoryTaxonomyTree returns the full active department -> category -> subcategory
	// tree in one query, shaped for the AI listing-suggestion prompt (pkg/service/ai).
