...
type ProductRepository interface {
	...
	SearchProducts(ctx context.Context, keyword string, categoryID, brandID, locationID *string, shopID *string, latitude, longitude, radius float64, pincode *uint, pagination request.Pagination) (products []response.ProductItems, err error)
