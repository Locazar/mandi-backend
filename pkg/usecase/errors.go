...
var (
	...
	// rewards
	ErrRewardProgramDisabled  = errors.New("the Locazar rewards program is currently paused")
	ErrRewardCustomerOnly     = errors.New("only customer accounts can record shop purchases")
	ErrRewardShopNotFound     = errors.New("shop not found")
	ErrShopNotOptedIn         = errors.New("this shop is not part of the Locazar rewards program")
	ErrShopLocationMissing    = errors.New("this shop has not set its location yet")
	ErrTooFarFromShop         = errors.New("you need to be at the shop to record a purchase")
	ErrSelfPurchase           = errors.New("you cannot record a purchase at your own shop")
	ErrRepeatPurchaseWindow   = errors.New("you already recorded a purchase at this shop recently")
	...
	ErrInvalidDiscountPercent = errors.New("discount percent is not one of the allowed values")
