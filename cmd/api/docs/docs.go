...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/departments/{department_id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Department card image",
                        "name": "photo",
                        "in": "formData"
                    },
                    {
        ...
        "/admin/items/ai-suggest-listing": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/notifications/radius": {
            "post": {
                ...
                "operationId": "SendRadiusAnnouncement",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.RadiusAnnouncement"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/notifications/shop-launch": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "SendShopLaunchAnnouncement",
                "parameters": [
                    {
                        "description": "Announcement",
                        "name": "input",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ShopLaunchAnnouncement"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/notifications/shop-launch/audience": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "PreviewShopLaunchAudience",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Shop ID",
        ...
        "/admin/onboarding-nudges/backfill": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "For shops that went live before this feature existed and so never got an\nanchor from the approve action. Idempotent — already-anchored shops are\nskipped. All anchored shops become due for their first nudge together on\nthe next sweep tick (a synchronized burst, not a trickle) — call this\ndeliberately, not routinely.",
                "tags": [
                    "Notification"
                ],
        ...
        "/admin/onboarding-nudges/run-sweep": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Same sweep cmd/onboarding-nudges runs on its Cloud Scheduler cadence —\nexposed here so an admin can trigger an out-of-band run (e.g. right after\nediting a template, or before the scheduled job is set up) without shelling\ninto anything. Synchronous: blocks until the sweep finishes.",
                "tags": [
                    "Notification"
                ],
        ...
        "/admin/onboarding-nudges/settings": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateOnboardingNudgeSettings"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/onboarding-nudges/shop-counts": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Comma-separated shop ids (max 500)",
                        "name": "shop_ids",
                        "in": "query",
                        "required": true
                    }
        ...
        "/admin/onboarding-nudges/templates": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/onboarding-nudges/templates/{key}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateOnboardingNudgeTemplate"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/rewards/program/accounts/{account_id}/adjust": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AdjustRewardAccountRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.RewardProgramConfig"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/rewards/program/purchases": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "pending|claimed|rejected|expired",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/admin/rewards/purchases/{purchase_id}/claim": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/rewards/purchases/{purchase_id}/reject": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/request.RejectShopPurchaseRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateShopRewardSettingsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/shops": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully got all shops",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to get all shops",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ShopDetails"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/shops/business-document/upload-pan-images": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "PAN images uploaded",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to upload PAN images",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/admin/shops/business-document/verify-pan": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PANVerifyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "PAN accepted, pending review",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/admin/shops/owner/{owner_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully got shop by owner ID",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ShopVerification"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully updated shop verification status",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/admin/shops/{shop_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully got shop by ID",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to get shop by ID",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/filters/cities/{city_id}/areas": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of areas for the given city",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/filters/pincode/{pincode_id}/location": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Location matching the pincode",
                        "schema": {
        ...
        "/filters/states/{state_id}/cities": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SendBroadcastRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/notifications/push": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Notification sent — response data carries {\\\"delivered\\\": bool}, true only if a device was actually reached",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.NotificationDeviceToken"
                        }
                    }
                ],
                "responses": {
        ...
        "/products/brand/{brand_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of products filtered by brand",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/products/category/{category_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of products matching category",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/products/location": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of products filtered by location",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/products/nearby": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Pincode to search around",
                        "name": "pincode",
                        "in": "query",
                        "required": true
                    },
        ...
        "/products/search/filters": {
            "get": {
                ...
                "operationId": "GetProductSearchFilters",
                "responses": {
                    "200": {
                        "description": "Successfully retrieved product search filters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "500": {
                        "description": "Failed to retrieve product search filters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/products/search/locations": {
            "get": {
                ...
                "operationId": "GetProductSearchLocations",
                "responses": {
                    "200": {
                        "description": "Successfully retrieved product search locations",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    "500": {
                        "description": "Failed to retrieve product search locations",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/products/search/suggestions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved product search suggestions",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to retrieve product search suggestions",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/review/shop/{shop_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully got shop review",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SubmitShopPurchaseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/rewards/shops/{shop_id}/eligibility": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/shop-updates": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Pincode (used when lat/long absent)",
                        "name": "pincode",
                        "in": "query"
                    }
                ],
        ...
        "/social/feedback/shop/{shop_id}": {
            "get": {
                ...
                "description": "Returns an array holding at most one entry: the feedback the\nauthenticated customer left for this shop, or an empty array if\nthey have not reviewed it. Other customers' feedback is never\nincluded — use /social/review/shop/{shop_id}/reviews for the\nshop-wide public list.",
                "tags": [
                    "User Feedback"
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.ShopFeedback"
                                            }
                                        }
                                    }
                                }
        ...
        "/taxonomy/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Restrict results to a single department",
                        "name": "department_id",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.TaxonomySearchResult"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "request.AdjustRewardAccountRequest": {
            "type": "object",
            "required": [
                "delta_points",
                "reason"
        ...
        "request.NotificationDeviceToken": {
            "type": "object",
            "required": [
                "owner_id",
                "owner_type",
        ...
        "request.RadiusAnnouncement": {
            ...
            "properties": {
                ...
                "image_url": {
                    "description": "ImageURL is optional; a stored object key or uploads/ path is absolutised\nserver-side, since FCM silently drops an image it cannot fetch.",
                    "type": "string"
                },
                "latitude": {
                    "type": "number",
        ...
        "request.RejectShopPurchaseRequest": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string",
        ...
        "request.SendBroadcastRequest": {
            ...
            "properties": {
                "audience": {
                    "description": "Audience selects the topic. Optional — defaults to \"all_users\" (all\ncustomer-app devices). Allowed: \"all_users\" | \"all_sellers\".",
                    "type": "string",
                    "enum": [
                        "all_users",
                        "all_sellers"
        ...
        "request.ShopLaunchAnnouncement": {
            "type": "object",
            "required": [
                "body",
                "radius_km",
            ...
            "properties": {
                ...
                "image_url": {
                    "description": "ImageURL overrides the shop's own photo. Empty means \"use the shop image\",\nwhich is the normal case.",
                    "type": "string"
                },
                "radius_km": {
                    "description": "RadiusKm is capped at 10: past that the \"shop near you\" premise stops\nbeing true and the push reads as spam.",
                    "type": "number",
                    "maximum": 10,
                    "minimum": 1
                },
        ...
        "request.ShopRatingAndReviewRequest": {
            ...
            "properties": {
                ...
                "customer_id": {
                    "description": "Accepted for backward compatibility but IGNORED: the customer is always taken from the auth token (see SaveShopRatingAndReview)",
                    "type": "string"
                },
                "rating": {
        ...
        "request.SubmitShopPurchaseRequest": {
            "type": "object",
            "required": [
                "bill_amount_paise",
                "client_request_id",
        ...
        "request.UpdateOnboardingNudgeSettings": {
            "type": "object",
            "required": [
                "duration_days",
                "gap_hours"
        ...
        "request.UpdateOnboardingNudgeTemplate": {
            "type": "object",
            "required": [
                "body",
                "title"
            ...
            "properties": {
                ...
                "route": {
                    "description": "Route is optional — an empty value means the tap just opens the app.",
                    "type": "string"
                },
                "title": {
                    "type": "string"
        ...
        "request.UpdateShopRewardSettingsRequest": {
            "type": "object",
            "required": [
                "discount_enabled"
            ],
        ...
        "response.TaxonomySearchResult": {
            "type": "object",
            "properties": {
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.TaxonomySearchItem"
                    }
                }
            }
        },
