...
COPY public.addresses (id, user_id, address_line1, address_line2, area, land_mark, city, pincode, country_id, latitude, longitude, created_at, updated_at, name, phone_number, house, address_line1, address_line2, address_type, is_default) FROM stdin;
\.
